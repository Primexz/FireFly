...
module.exports = {
    ...
    updateMusicMng: async function (interaction, client) {
        ...
        this.getYtDislikes(currentSong.id).then(dislikes => {
            interaction.message.edit({
                embeds: [new Discord.MessageEmbed()
                    ...
                    .addField(":eye: Views", `> ${currentSong.views ? this.formatInt(currentSong.views) : "N/A"}`, true)
                    .addField("👍 Likes", `> ${currentSong.likes ? this.formatInt(currentSong.likes) : "N/A"}`, true)
                    .addField("👎 Dislikes", `> ${currentSong.source == "youtube" ? this.formatInt(dislikes) : "N/A"}`, true)
